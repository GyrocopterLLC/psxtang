...
VERILOG_SOURCES ?= $(PWD)/../fb_top.sv
VERILOG_SOURCES += $(PWD)/../fb_mem_control.sv
VERILOG_SOURCES += $(PWD)/../fb_write_control.sv
VERILOG_SOURCES += $(PWD)/../fb_read_control.sv
VERILOG_SOURCES += $(PWD)/../cdc_fifo.sv
